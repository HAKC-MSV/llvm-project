...
CodeGenFunction::EmitAutoVarAlloca(const VarDecl &D) {
  ...
  if (D.hasAttr<KernelUserPtrAttr>()) {
    llvm::Instruction *instruction =
        dyn_cast<llvm::Instruction>(address.getBasePointer());
