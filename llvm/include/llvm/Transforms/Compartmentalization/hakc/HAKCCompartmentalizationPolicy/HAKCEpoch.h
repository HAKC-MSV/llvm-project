...
//
// public:
//  TICTACEpoch(std::string typeString, tictac_epoch_id_t epochID,
//  tictac_epoch_id_t nextEpoch); std::string getTypeString(); void
//  assignType(Type *ty); tictac_epoch_id_t GetEpochID(); tictac_epoch_id_t
//  GetNextEpochID(); Value *GetNextEpochIDAsValue(LLVMContext &context); Type*
//  getType(); friend raw_ostream &operator<<(raw_ostream &os, TICTACEpoch
//  &Epoch);
//};
//
//} // hakc
