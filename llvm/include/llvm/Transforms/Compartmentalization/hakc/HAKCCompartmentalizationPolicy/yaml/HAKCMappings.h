...
template<>
struct llvm::yaml::MappingTraits<llvm::hakc::HAKCYamlType> {
...
template<>
struct llvm::yaml::MappingTraits<llvm::hakc::HAKCYamlScope> {
...
template<>
struct yaml::MappingTraits<llvm::hakc::HAKCYamlClique> {
...
template<>
struct yaml::MappingTraits<llvm::hakc::HAKCYamlCompartment> {
...
template<>
struct yaml::MappingTraits<llvm::hakc::HAKCYamlSymbol> {
