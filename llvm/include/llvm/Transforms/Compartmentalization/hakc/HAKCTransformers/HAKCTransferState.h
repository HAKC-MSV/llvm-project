...
namespace llvm::hakc {
    ...
    protected:
        ...
        // this will store the actual std::string values for all transfers; all other labels will be StringRefs
        ...
        // replacing map with vector since one action can map to multiple values, e.g., save both input and output values as labels
