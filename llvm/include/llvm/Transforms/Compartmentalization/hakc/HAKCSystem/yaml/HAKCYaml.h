...
template <> struct yaml::MappingTraits<hakc::HAKCYAMLEndpoints> {
  static void mapping(yaml::IO &Io, hakc::HAKCYAMLEndpoints &Endpoints) {
    ...
    Io.mapOptional("get-division-by-id-endpoint", Endpoints.GetDivisionEndpoint,
                   "get-division-id");
    ...
    Io.mapOptional("add-function-endpoint", Endpoints.AddFunctionEndpoint,
                   "add-function");
    Io.mapOptional("add-symbols-endpoint", Endpoints.AddSymbolsEndpoint,
                   "add-symbols");
    Io.mapOptional("add-global-variable-endpoint",
                   Endpoints.AddGlobalVariableEndpoint, "add-global-variable");
...
template <> struct yaml::MappingTraits<hakc::HAKCYAMLClientConfig> {
  static void mapping(IO &io, hakc::HAKCYAMLClientConfig &ClientConfig) {
    ...
    io.mapOptional("max-connection-retries", ClientConfig.MaxConnectionRetries,
                   1);
...
template <> struct yaml::MappingTraits<hakc::HAKCYAMLConfig> {
  static void mapping(IO &io, hakc::HAKCYAMLConfig &YamlConfig) {
    ...
    ErrorOr<std::unique_ptr<MemoryBuffer>> mb =
        MemoryBuffer::getFile(YamlConfig.ClientConfigPath);
    ...
    //   ErrorOr<std::unique_ptr<MemoryBuffer> > mb =
    //   MemoryBuffer::getFile(YamlConfig.ClientConfigPath); Input
    //   yin(mb.get()->getMemBufferRef().getBuffer()); yin >>
    //   YamlConfig.ClientConfig; if (yin.error()) {
    ...
    //   std::unique_ptr<hakc::HAKCYAMLClientConfig> ClientConfig =
    //   std::make_unique<hakc::HAKCYAMLClientConfig>(); YamlConfig.ClientConfig
    //   = *ClientConfig;
    //
    // }
