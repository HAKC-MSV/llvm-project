...
public:
  ...
  virtual void
  SendSymbolsToAnalysisServer(HAKCTypeIdentifier &TypeIdentifier) = 0;
...
protected:
  ...
  HAKCDivisionP CreateDivision(hakc_compartment_id_t CompartmentID,
                               hakc_compartment_division_t DivisionID,
...
public:
  explicit FakeServerClient(HAKCModuleAnalysis &ModuleAnalysis, bool NecOnly);
