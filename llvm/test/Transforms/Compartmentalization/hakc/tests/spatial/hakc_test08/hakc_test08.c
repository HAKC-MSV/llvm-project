...
// CHECK: call ptr @check_hakc_data_access(ptr %1, i64 1, i64 65536)
        *v1++;
// CHECK: call ptr @check_hakc_data_access(ptr %4, i64 1, i64 65536)
        *v2++;
        struct data_struct b;
        b.a = 0;
// CHECK: call ptr @check_hakc_code_access(ptr %8, i64 1, i64 65536, ptr @entry_tokens_1, i64 2)
        return a->f(&b);
    }
    return 0;
}
...
// CHECK: call ptr @hakc_transfer_to_clique(ptr %1, i64 4, i64 1, i32 13, i1 false)
// CHECK: call i32 @get_hakc_address_color(ptr %2)
// CHECK: call ptr @hakc_transfer_to_clique(ptr %2, i64 4, i64 1, i32 13, i1 false)
// CHECK: call i32 @HAKC_ORIG_foo(ptr %4, ptr %6, ptr %8)
// CHECK: call void @hakc_color_address(ptr %2, i32 %7, i64 4)
// CHECK: call void @hakc_color_address(ptr %1, i32 %5, i64 4)
// CHECK: call void @hakc_color_address(ptr %0, i32 %3, i64 8)
