...
// CHECK: call ptr @hakc_transfer_to_clique(ptr %0, i64 8, i64 4, i64 13, i1 false)
// CHECK: call i32 @get_hakc_address_color(ptr %1)
// CHECK: call ptr @hakc_transfer_to_clique(ptr %1, i64 8, i64 4, i64 13, i1 false)
// CHECK: call i32 @get_hakc_address_color(ptr %2)
// CHECK: call ptr @hakc_transfer_to_clique(ptr %2, i64 8, i64 4, i64 13, i1 false)
// CHECK: call i32 @HAKC_ORIG_foo(ptr %4, ptr %6, ptr %8)
// CHECK: call void @hakc_color_address(ptr %2, i32 %7, i64 8)
// CHECK: call void @hakc_color_address(ptr %1, i32 %5, i64 8)
