...
def HAKC_PROCESS_YAML_CONFIGS(HAKC_TEST_SOURCE, HAKC_ROOT, HAKC_BASE_FNAME, HAKC_BUILD_PATH, HAKC_BACKING_TYPE):
    ...
    try:
        ...
        content = content.replace("@HAKC_SOCKET_PATH@", HAKC_ROOT + "/hakc-socket")
    ...
    try:
        ...
        content = content.replace("@HAKC_BACKING_TYPE@", HAKC_BACKING_TYPE)
        content = content.replace("@HAKC_SOCKET_PATH@", HAKC_ROOT + "/hakc-socket")
...
def process(HAKC_TEST_SOURCE, HAKC_BACKING_TYPE):
    HAKC_ROOT = run_command("git rev-parse --show-toplevel")
    ...
    # Do a clean build
    run_command(f"rm -rf {HAKC_BUILD_PATH} && mkdir {HAKC_BUILD_PATH}")

    HAKC_PROCESS_YAML_CONFIGS(HAKC_TEST_SOURCE, HAKC_ROOT, HAKC_BASE_FNAME, HAKC_BUILD_PATH, HAKC_BACKING_TYPE)
