...
namespace llvm::hakc {
HAKCFunctionArgumentDefinition::HAKCFunctionArgumentDefinition(
...
HAKCFunctionDefinition::HAKCFunctionDefinition(
  ...
  llvm::sort(ArgList.begin(), ArgList.end(),
             [](const HAKCFunctionArgumentDefinition &LHS,
                const HAKCFunctionArgumentDefinition &RHS) {
               return LHS.Idx < RHS.Idx;
             });
}

StringRef HAKCFunctionDefinition::GetName() const { return F->getName(); }

Function *HAKCFunctionDefinition::GetFunction() const { return F; }
...
iterator_range<SmallVector<HAKCFunctionArgumentDefinition>::iterator>
HAKCFunctionDefinition::Args() {
