...
HAKCCompartmentDivision::HAKCCompartmentDivision(
    const HAKCCompartment &C, const hakc_compartment_division_t DivisionID,
...
bool HAKCCompartmentDivision::operator==(
    const HAKCCompartmentDivision &RHS) const {
  return DivisionID == RHS.GetDivisionID() &&
         GetHAKCCompartment().GetCompartmentID() ==
             RHS.GetHAKCCompartment().GetCompartmentID();
}
...
bool HAKCCompartmentDivision::operator<(
    const HAKCCompartmentDivision &Div) const {
  return GetHAKCCompartment().GetCompartmentIDValue() <
             Div.GetHAKCCompartment().GetCompartmentIDValue() &&
