...
hakc::HAKCLogger::HAKCLogger(HAKCLogLevel log_level) : LogLevel(Verbose), disabled(false) {
...
void hakc::HAKCLogger::SetLogLevel(const HAKCLogLevel log_level) { LogLevel = log_level; }

void hakc::HAKCLogger::SetConsoleConfiguredLogLevel(const HAKCLogLevel log_level) const { HAKCStreams[0]->SetConfiguredLogLevel(log_level); }

void hakc::HAKCLogger::SetFileConfiguredLogLevel(const HAKCLogLevel log_level) const {
