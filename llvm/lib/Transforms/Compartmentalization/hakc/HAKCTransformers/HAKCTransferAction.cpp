...
hakc::HAKCTransferAction::HAKCTransferAction(
    ...
    : Label(Label), HAKCActionFunction(HAKCActionFunction), Arguments() {}

StringRef hakc::HAKCTransferAction::GetLabel() const { return Label; }

iterator_range<SmallVector<hakc::HAKCActionArgument>::iterator>
hakc::HAKCTransferAction::GetArguments() {
  return make_range(Arguments.begin(), Arguments.end());
}

hakc::HAKCFunctionDefinition &
hakc::HAKCTransferAction::GetHAKCActionFunction() const {
