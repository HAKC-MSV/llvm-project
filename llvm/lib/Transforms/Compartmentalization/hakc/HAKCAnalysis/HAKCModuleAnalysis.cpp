...
std::string
HAKCModuleAnalysis::getGlobalHAKCSectionName(GlobalVariable *GV) const {
...
bool HAKCModuleAnalysis::AliasShouldBeCreated(Function *F) {
  //         /* See note in
  //         HAKCModuleAnalysisLinux::TransferFunctionShouldBeCreated */ if
...
bool HAKCModuleAnalysis::ConstantStructTransferIsNeeded(
...
void HAKCModuleAnalysis::PopulateGlobalInitTransferFunc(
